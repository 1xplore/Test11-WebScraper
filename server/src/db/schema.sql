...
-- Loop 21 扩 seed — 行业子领域资质（整词短语，对应实际公告里出现的具体资质）
INSERT OR IGNORE INTO qual_rules (priority, tag, keywords, source) VALUES
  -- 综合资质
  (10, '工程勘察综合甲级',       '工程勘察综合甲级',                                  'seed'),
  (10, '工程设计综合甲级',       '工程设计综合甲级',                                  'seed'),
  -- 设计专项
  (10, '风景园林工程设计专项',   '风景园林工程设计专项|风景园林设计专项',         'seed'),
  (10, '建筑装饰设计专项',       '建筑装饰设计专项',                                  'seed'),
  (10, '照明工程设计专项',       '照明工程设计专项',                                  'seed'),
  -- 勘察子项
  (10, '岩土工程勘察甲级',       '岩土工程勘察&甲级|岩土工程&甲级',                 'seed'),
  (10, '工程测量专业甲级',       '工程测量专业甲级|工程测量甲级',                   'seed'),
  -- 监理子项
  (10, '房屋建筑工程监理甲级',   '房屋建筑工程监理甲级',                              'seed'),
  ...
  -- 工程造价咨询企业
  (10, '工程造价咨询企业资质',   '工程造价咨询企业资质|工程造价咨询企业',         'seed'),
  -- 政府采购代理
  (10, '政府采购代理机构',       '政府采购代理机构',                                  'seed'),
  -- 中央投资代理
